...
> 依据：[`plan.md`](../plan.md)（Workflow 总规划 V0.1）、[`docs/optimization-plan.md`](../docs/optimization-plan.md)（工程化优化）、
...
围绕 [`docs/optimization-plan.md`](../docs/optimization-plan.md) 已完成的 S1–S4 结构重构，继续推进剩余闭环：
