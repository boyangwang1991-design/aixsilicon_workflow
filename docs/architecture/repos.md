...
> 全景依赖源：[`manifests/default.yaml`](../../manifests/default.yaml)；Schema 所有权：[`docs/workflow/schema-ownership.md`](../workflow/schema-ownership.md)；写入边界：[`ownership-map.yaml`](../../ownership-map.yaml)。
...
- **Schema 所有权**：`interface-contract / profile / binding / compatibility`（[`docs/workflow/schema-ownership.md`](../workflow/schema-ownership.md)）。
...
- **当前内容**：`knowledge/`、`schemas/`、`templates/`、`skills/`、`assets/`、知识手册相关文档（原 `ROADMAP.md`/`TODO.md`/`plans/reference-material-spec.md` 已收口至 [`docs/knowledge/plan.md`](../knowledge/plan.md) 与 [`docs/knowledge/todo.md`](../knowledge/todo.md)）。
...
### 2.4 Schema 所有权关系（[`docs/workflow/schema-ownership.md`](../workflow/schema-ownership.md)）
...
- **规划文件已收口**：各子仓 plan/todo 已收口至 `docs/` 各仓 plan.md/todo.md（索引见 [`docs/index.md`](../index.md) §各仓 Plan / Todo）。
...
- 全仓清单：**[gitlist.md](../../gitlist.md)**、**[docs/workflow/schema-ownership.md](../workflow/schema-ownership.md)**
