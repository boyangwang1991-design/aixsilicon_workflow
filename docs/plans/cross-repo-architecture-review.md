...
> 依据：各仓 plan/README、[`docs/schema-ownership.md`](../docs/schema-ownership.md)、[`docs/adr/0003-0006`](../docs/adr/README.md)。
...
| R3 | Schema 重复维护：各仓各定义同域 Schema | workflow / hwif / dv-common / tool / catalog | **重复（已治理）** | [`docs/schema-ownership.md`](../docs/schema-ownership.md) 单一 Owner |
