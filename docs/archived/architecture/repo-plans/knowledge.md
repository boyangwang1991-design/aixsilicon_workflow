# knowledge — AIXSILICON ChipKnowledge 知识库 规划与待办
...
| 文件 | 格式 | 大小 | 说明 |
|------|------|------|------|
| [ieee-1800-2023.pdf](origin/ieee-1800-2023.pdf) | PDF | 15.2MB | 标准原文 |
...
- [KNOW-RTL-0001: 同步 FIFO 设计](/knowledge/volumes/07-rtl-design/01-synthesizable-rtl-semantics)
- [第 07 卷: RTL 设计方法](/knowledge/volumes/07-rtl-design/)
